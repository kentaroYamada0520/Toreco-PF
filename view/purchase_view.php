          ...
          <form method="post" action="purchase_confirmed_process.php" class="needs-validation" nobalidate>
            <div class="row g-3">
              ...
              <div class="col-sm-6" style="padding:10px;">
                ...
                <input type="text" id="real_name" class="form-control" name="real_name" value="<?php print $user['real_name']; ?>">
              </div>
              <div class="col-12">
                <label for="mail_address" class="form-label">メールアドレス</label>
                <input type="text" id="mail_address" class="form-control" name="mail_address" value="<?php print $user['mail_address']; ?>">
              </div>
              <div class="col-12">
                <label for="address" class="form-label">住所</label>
                <input type="text" id="address" class="form-control" name="address" value="<?php print $user['address']; ?>">
              </div>
              <hr class="my-4">
