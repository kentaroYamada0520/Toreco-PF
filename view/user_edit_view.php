...
<body>
  ...
  <div class="container">
    ...
    <div class="form-group">
        <p>名前: </p>
        <input type="text" name="real_name" value="<?php print $user[
            'real_name'
        ]; ?>">
      </div>
      <div class="form-group">
        <p>ユーザー名: </p>
        <input type="text" name="user_name" value="<?php print $user[
            'user_name'
        ]; ?>">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <option value="<?php print $user[
            'question_code'
        ]; ?>" selected ><?php print $user['question_content']; ?> </option>
      ...
      <div class="form-group">
        <p>秘密の質問の答え: </p>
        <input type="text" name="question_answer" value="<?php print $user[
            'question_answer'
        ]; ?>">
      </div>
      <div class="form-group">
        <p>最寄り宅急便センター住所: </p>
        <input type="text" name="address" value="<?php print $user[
            'address'
        ]; ?>">
      </div>
      <div class="form-group">
        <p>自己紹介文: </p>
        <input type="textarea" name="user_introduction" value="<?php print $user[
            'user_introduction'
        ]; ?>">
      </div>
