  ...
  <div class="conteiner">
    ...
    <h4 class="d-flex justify-content-between align-items-center md-3">
      ...
      <ul class="list-group mb-3">
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
          <h6 class="my-0">メールアドレス：<?php print $user[
              'mail_address'
          ]; ?></h6>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
          <h6 class="my-0">パスワード：<?php print $user['password']; ?></h6>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
          <h6 class="my-0">秘密の質問：<?php print $user[
              'question_content'
          ]; ?></h6>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
          <h6 class="my-0">秘密の質問の答え：<?php print $user[
              'question_answer'
          ]; ?></h6>
          </li>
          <li class="list-group-item d-flex justify-content-between lh-sm">
          ...
          <li class="list-group-item d-flex justify-content-between lh-sm">
          <h6 class="my-0">自己紹介：<?php print $user[
              'user_introduction'
          ]; ?></h6>
          </li>
      </ul>
